onload = () => {
    (document.getElementById('adiciona-telefone') as HTMLButtonElement)
        .addEventListener('click', adicionaTelefone);
    (document.getElementById('adiciona-email') as HTMLButtonElement)
        .addEventListener('click', adicionaEmail);
}
...
function adicionaEmail() {
    ...
    // cria o botão para remover o campo de email
    ...
    (document.getElementById("emails") as HTMLTableCellElement)
        .innerHTML += div;
}
...
function adicionaTelefone() {
    ...
    // cria o botão para remover o campo de telefone
    ...
    // adiciona o div na tela
    (document.getElementById("telefones") as HTMLTableCellElement)
        .appendChild(div);
}