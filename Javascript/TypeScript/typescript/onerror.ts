...

{
    try {
        ...
        console.log("Nome do erro: " + (e as Error).name + "<br/>");
        console.log("Mensagem de erro: " + (e as Error).message + "<br/>");
        console.log("Pinha no momento do erro: " + (e as Error).stack + "<br/>");
    } finally {
...

{
    ...
    try {
        ...
        if (typeof e === "object" && e !== null && "name" in e && "message" in e) {
            const err = e as { name: string; message: string; number?: number; description?: string };
